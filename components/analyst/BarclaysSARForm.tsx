        ...
        <div className="max-w-4xl mx-auto bg-white shadow-lg border border-slate-200 font-sans text-slate-900 mb-20">
            ...
            <div className="p-6 space-y-6">
                ...
                <div className="border border-slate-200">
                    ...
                    <div className="p-4">
                        ...
                        <textarea 
                            ...
                            className="w-full h-80 p-3 text-sm border border-slate-300 bg-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none rounded-md"
                            disabled={false}
                        />
                    </div>
                </div>
                ...
                <div className="flex justify-center pt-6 border-t border-slate-200">
                    <button 
                        onClick={() => onFinalize()}
                        className="bg-blue-900 text-white px-8 py-3 font-bold text-xs uppercase tracking-widest hover:bg-blue-800 active:scale-95 transition-all shadow-md"
                    >
